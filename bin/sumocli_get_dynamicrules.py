...
"""
Exaplanation: get_dynamicrules a cmdlet within the sumocli that retrieves information

Usage:
   $ python  get_dynamicrules [ options ]

Style:
   Google Python Style Guide:
   http://google.github.io/styleguide/pyguide.html

    @name           sumocli_get_dynamicrules
    @version        1.00
...
get_dynamicrules is part of sumocli, a tool which wraps the Sumologic API.
...
def run_sumo_cmdlet(src):
    ...
    src_items = src.get_dynamicrules()
