...
"""
Exaplanation: query_connections a cmdlet within the sumocli that retrieves information

Usage:
   $ python  query_connections [ options ]

Style:
   Google Python Style Guide:
   http://google.github.io/styleguide/pyguide.html

    @name           sumocli_query_connections
    @version        1.00
...
query_connections is a Sumo Logic cli cmdlet retrieving information about connections
""")
