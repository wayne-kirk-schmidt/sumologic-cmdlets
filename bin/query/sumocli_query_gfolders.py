...
"""
Exaplanation: query_globalfolders a cmdlet within the sumocli that retrieves information

Usage:
   $ python  query_globalfolders [ options ]

Style:
   Google Python Style Guide:
   http://google.github.io/styleguide/pyguide.html

    @name           sumocli_query_globalfolders
    @version        1.00
...
query_gfolders is a Sumo Logic cli cmdlet retrieving information about gfolders
""")
