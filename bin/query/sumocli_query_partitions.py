...
"""
Exaplanation: query_partitions a cmdlet within the sumocli that retrieves information

Usage:
   $ python  query_partitions [ options ]

Style:
   Google Python Style Guide:
   http://google.github.io/styleguide/pyguide.html

    @name           sumocli_query_partitions
    @version        1.00
...
query_partitions is a Sumo Logic cli cmdlet retrieving information about partitions
""")
