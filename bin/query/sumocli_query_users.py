...
"""
Exaplanation: query_users a cmdlet within the sumocli that retrieves information

Usage:
   $ python  query_users [ options ]

Style:
   Google Python Style Guide:
   http://google.github.io/styleguide/pyguide.html

    @name           sumocli_query_users
    @version        1.00
...
query_users is a Sumo Logic cli cmdlet retrieving information about users
""")
