...
"""
Exaplanation: query_roles a cmdlet within the sumocli that retrieves information

Usage:
   $ python  query_roles [ options ]

Style:
   Google Python Style Guide:
   http://google.github.io/styleguide/pyguide.html

    @name           sumocli_query_roles
    @version        1.00
...
query_roles is a Sumo Logic cli cmdlet retrieving information about roles
""")
