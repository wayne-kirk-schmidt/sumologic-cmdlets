...
"""
Exaplanation: list_scheduledViews a cmdlet within the sumocli that retrieves information

Usage:
   $ python  list_scheduledViews [ options ]

Style:
   Google Python Style Guide:
   http://google.github.io/styleguide/pyguide.html

    @name           sumocli_list_scheduledViews
    @version        1.00
...
list_scheduledViews is a Sumo Logic cli cmdlet retrieving information about scheduledViews
""")
...
def run_sumo_cmdlet(source):
    ...
    """
    target_object = "scheduledViews"
    target_dict = {}
    target_dict["orgid"] = SUMO_ORG
    target_dict[target_object] = {}

    src_items = source.get_scheduled_views()
...
### methods ###
    ...
    def get_scheduled_view(self, myself):
        """
