...
"""
Exaplanation: list_fields a cmdlet within the sumocli that retrieves information

Usage:
   $ python  list_fields [ options ]

Style:
   Google Python Style Guide:
   http://google.github.io/styleguide/pyguide.html

    @name           sumocli_list_fields
    @version        1.00
