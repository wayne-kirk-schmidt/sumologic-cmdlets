...
"""
Exaplanation: list_sources a cmdlet within the sumocli that retrieves information

Usage:
   $ python  list_sources [ options ]

Style:
   Google Python Style Guide:
   http://google.github.io/styleguide/pyguide.html

    @name           sumocli_list_sources
    @version        1.00
...
list_sources is a Sumo Logic cli cmdlet retrieving information about sources
""")
