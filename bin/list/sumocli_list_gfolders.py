...
"""
Exaplanation: list_globalfolders a cmdlet within the sumocli that retrieves information

Usage:
   $ python  list_globalfolders [ options ]

Style:
   Google Python Style Guide:
   http://google.github.io/styleguide/pyguide.html

    @name           sumocli_list_globalfolders
    @version        1.00
...
list_gfolders is a Sumo Logic cli cmdlet retrieving information about gfolders
""")
