...
"""
Exaplanation: list_fers a cmdlet within the sumocli that retrieves information

Usage:
   $ python  list_fers [ options ]

Style:
   Google Python Style Guide:
   http://google.github.io/styleguide/pyguide.html

    @name           sumocli_list_fers
    @version        1.00
...
list_fers is a Sumo Logic cli cmdlet retrieving information about fers
""")
