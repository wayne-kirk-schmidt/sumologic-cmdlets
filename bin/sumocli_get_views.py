...
"""
Exaplanation: get_views a cmdlet within the sumocli that retrieves fer information
...
get_views is part of sumocli, a tool which wraps the Sumologic API.
...
### included code
    ...
    def get_view(self, myself):
        ...
        """
        url = self.base_url + "/v1/scheduledViews/" + str(myself)
        return self.__http_get(url)['data']
