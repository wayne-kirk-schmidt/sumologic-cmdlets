...
"""
Exaplanation: get_users a cmdlet within the sumocli that retrieves information

Usage:
   $ python  get_users [ options ]

Style:
   Google Python Style Guide:
   http://google.github.io/styleguide/pyguide.html

    @name           sumocli_get_users
    @version        1.00
...
get_users is a Sumo Logic cli cmdlet retrieving information about users
""")
