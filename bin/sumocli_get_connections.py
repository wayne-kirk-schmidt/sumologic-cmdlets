...
get_connections is part of sumocli, a tool which wraps the Sumologic API.
...
### included code
    ...
    def get_connection(self, myself):
        ...
        """
        url = self.base_url + "/v1/connections/" + str(myself)
        return self.__http_get(url)['data']
