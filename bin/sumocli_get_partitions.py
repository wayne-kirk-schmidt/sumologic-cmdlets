...
"""
Exaplanation: get_partitions a cmdlet within the sumocli that retrieves fer information
...
get_partitions is part of sumocli, a tool which wraps the Sumologic API.
...
### included code
    ...
    def get_partitions(self):
        ...
        """
        url = self.base_url + "/v1/partitions"
    ...
    def get_partition(self, myself):
        ...
        """
        url = self.base_url + "/v1/partitions/" + str(myself)
        return self.__http_get(url)['data']
